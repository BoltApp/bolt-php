...
$cartData = $exampleData->generateCartPaymentOnly();

$cartItems = @$cartData['cart']['items'];
$currency = @$cartData['cart']['currency'];
$discounts = @$cartData['cart']['discounts'];
$taxAmount = @$cartData['cart']['tax_amount'];
$shipments = @$cartData['cart']['shipments'];
...
<head>
    ...
    <?= \BoltPay\Helper::renderBoltTrackScriptTag(true); ?>
    <?= \BoltPay\Helper::renderBoltConnectScriptTag(true); ?>
    <style>
        * {
